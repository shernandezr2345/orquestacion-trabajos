...
| D07 | Administración híbrida para la POC: una instancia Cloud SQL PostgreSQL y una base lógica privada por servicio |  Usuarios y permisos exclusivos, sin tablas compartidas ni acceso cruzado. Se acepta compartir recursos, mantenimiento y riesgo de fallo del motor para reducir costo. |
